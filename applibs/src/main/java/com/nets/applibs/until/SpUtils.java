...
public class SpUtils {
    ...
    private SpUtils() {
       String rootDir =MMKV.initialize(AppAppliction.appliction);
        mv = MMKV.defaultMMKV();
    }
    ...
    public static Boolean decodeBoolean(String key,boolean defaultVal) {
        return mv.decodeBool(key, defaultVal);
    }
    ...
    public static String decodeString(String key,String vals) {
        return mv.decodeString(key,vals);
    }
    ...
    public static <T extends  Parcelable>T decodeObject(String key,Class<T> tClass,T defaultValue) {
        return mv.decodeParcelable(key, tClass,defaultValue);
    }
    public static <T extends  Parcelable> void encodeObject(String key,T value) {
        mv.encode(key, value);
    }
    /**
     * 移除某个key对
